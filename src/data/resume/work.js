...
const work = [
  {
    ...
    startDate: '2025-07',
    highlights: [
      'Developed a Red/Green Health Score Dashboard in Datadog, summarizing CPU, memory, latency, and error metrics across all internal cloud services, reducing troubleshooting time by 30+ mintues.',
